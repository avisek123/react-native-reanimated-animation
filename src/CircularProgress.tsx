 ...
 **/
const rotateByStyle = (percent: any, base_degrees: any, clockwise: any) => {
  ...
  return (
    <View style={[styles.container, {width: radius * 2, height: radius * 2}]}>
      ...
      <View
        ...
        <Text style={[styles.text, {fontSize: 16}]}>{'01:04'}</Text>
        <Text style={[styles.text, {opacity: 0.7}]}>{`${10}hr`}</Text>
      </View>
    </View>
  );
};
// default values for props
CircularProgressNew.defaultProps = {
  percent: 0,
  radius: 100,
  bgRingWidth: 12,
  progressRingWidth: 6,
